...
# The PyBullet half of the sim-to-sim check uses the committed kinematic
# URDF simulation/pybullet/go2_simple_kin.urdf (generated once from the
# menagerie go2.xml itself, meshes stripped for pure kinematics; see
